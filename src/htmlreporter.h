...
class HtmlReporter
{
    public:
        ...
        void setDupHist(int *    dupHist,
                        double * dupMeanGC,
                        double   dupRate);

        void setInsertHist(long * insertHist,
                           int    insertSizePeak);

        void report(S2FReportTuple & mS2FReportTuple,
                    FilterResult *   result,
                    Stats *          preStats1,
                    Stats *          postStats1,
                    Stats *          preStats2 = NULL,
                    Stats *          postStats2 = NULL);

        static void outputRow(ofstream & ofs,
                              string     key,
                              long       value);
        ...
        static string getPercents(long numerator,
                                  long denominator);
    ...
    private:
        ...
        void reportInsertSize(ofstream & ofs,
                              int        isizeLimit);

        void printSummary(ofstream &     ofs,
                          FilterResult * result,
                          Stats *        preStats1,
                          Stats *        postStats1,
                          Stats *        preStats2,
        ...
        void printAnnotationResults(ofstream &       ofs,
                                    S2FReportTuple & mS2FReportTuple);
        ...
        void reportGeneBarPlot(ofstream & ofs,
