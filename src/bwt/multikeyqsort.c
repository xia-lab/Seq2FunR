...
static inline void swap(char * a[],
                        int    i,
                        int    j)
{
    char * t = a[i];
...
static inline void vecswap(char * a[],
                           int    i,
                           int    j,
                           int    n)
{
...
static inline int my_strcmp(const char * s1,
                            const char * s2)
{
    while (*s1 && *s2 && (*s1 == *s2))
    {
...
static inline int med3func(char * a[],
                           int    ia,
                           int    ib,
                           int    ic,
                           int    depth)
{
    ...
    return (va < vb) ? ((vb < vc) ? ib : ((va < vc) ? ic : ia)) : ((vb > vc) ? ib : ((va < vc) ? ia : ic));
}
