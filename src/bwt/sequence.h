...
static inline int letter2number(char             c,
                                AlphabetStruct * a)
{
    return a -> trans[(int) c];
}

static inline char number2letter(int              i,
                                 AlphabetStruct * a)
{
    return a -> a[i];
}
...
AlphabetStruct * alloc_AlphabetStruct(char * a,
        int                                  caseSens,
        int                                  revcomp);

void free_AlphabetStruct(AlphabetStruct * astruct);

void translate2numbers(uchar *          s,
                       const IndexType  slen,
