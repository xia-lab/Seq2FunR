...
typedef std::tuple<std::vector<std::tuple<std::string, int, std::string> >,
				   ...
				   std::vector<std::pair<std::string, int> >,
				   std::map<int, int>,
				   std::map<int, int> > S2FReportTuple;
const char ATCG_BASES[] =
{
    'A', 'T', 'C', 'G'
};
...
{
    "passed", "", "", "", "failed_polyx_filter", "", "", "", "failed_bad_overlap", "", "", "",
    "failed_too_many_n_bases", "", "", "", "failed_too_short", "failed_too_long", "", "", "failed_quality_filter", "",
