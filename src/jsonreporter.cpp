...
void JsonReporter::setDupHist(int *    dupHist,
                              double * dupMeanGC,
                              double   dupRate)
{
    mDupHist   = dupHist;
...
void JsonReporter::setInsertHist(long * insertHist,
                                 int    insertSizePeak)
{
...
void JsonReporter::report(FilterResult * result,
                          Stats *        preStats1,
                          Stats *        postStats1,
                          Stats *        preStats2,
                          Stats *        postStats2)
{
    ...
    ofs << "\t\t\t" << "\"q20_rate\":"
        << ((pre_total_bases == 0) ? 0.0 : (double) pre_q20_bases / (double) pre_total_bases) << "," << endl;
    ofs << "\t\t\t" << "\"q30_rate\":"
        << ((pre_total_bases == 0) ? 0.0 : (double) pre_q30_bases / (double) pre_total_bases) << "," << endl;
    ...
    ofs << "\t\t\t" << "\"gc_content\":"
        << ((pre_total_bases == 0) ? 0.0 : (double) pre_total_gc / (double) pre_total_bases) << endl;
    ofs << "\t\t" << "}," << endl;
    ...
    ofs << "\t\t\t" << "\"q20_rate\":"
        << ((post_total_bases == 0) ? 0.0 : (double) post_q20_bases / (double) post_total_bases) << "," << endl;
    ofs << "\t\t\t" << "\"q30_rate\":"
        << ((post_total_bases == 0) ? 0.0 : (double) post_q30_bases / (double) post_total_bases) << "," << endl;
    ...
    ofs << "\t\t\t" << "\"gc_content\":"
        << ((post_total_bases == 0) ? 0.0 : (double) post_total_gc / (double) post_total_bases) << endl;
    ofs << "\t\t" << "}";
    ofs << endl;
    ofs << "\t" << "}," << endl;
