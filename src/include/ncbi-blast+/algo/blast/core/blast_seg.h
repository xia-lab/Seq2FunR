...
extern "C"
{
     ...
     */
    NCBI_XBLAST_EXPORT SegParameters * SegParametersNewAa(void);

    /**
     *  Free SegParameters structure
     * @param sparamsp object to be freed [in]
     */
    NCBI_XBLAST_EXPORT void SegParametersFree(SegParameters * sparamsp);
     ...
     */
    NCBI_XBLAST_EXPORT Int2 SeqBufferSeg(Uint1 * sequence,
            Int4                                 length,
            Int4                                 offset,
