...
extern "C"
{
    ...
    {
        Uint1   letter;        /**<
                                *  Preferred letter at this position, in
                                * ncbistdaa encoding
                                */
    ...
    typedef struct PSIMsaDimensions
    {
        ...
        Uint4 num_seqs;        /**<
                                *  Number of distinct sequences aligned with the
...
#ifdef DEBUG_PSSM_ENGINE
        PSISeqInfo *       seqinfo;       /**
                                           *  sequence information for a row of the
     ...
     */
    NCBI_XBLAST_EXPORT PSIMsa * PSIMsaNew(const PSIMsaDimensions * dimensions);
     ...
     * @return NULL
     */
    NCBI_XBLAST_EXPORT PSIMsa * PSIMsaFree(PSIMsa * msa);
    ...
    {
        double * wfreqs;    /**<
                             *  Frequencies for each residue in
                             *    CD column
                             */
        double   iobsr;     /**<
    ...
    {
        Uint1              is_aligned;    /**<
                                           *  Does this cell represent column aligned
                                           *    to a CD
                                           */
...
#ifdef DEBUG_PSSM_ENGINE
    NCBI_XBLAST_EXPORT void PrintMsa(const char *   filename,
                                     const PSIMsa * msa);

    NCBI_XBLAST_EXPORT void PrintMsaFP(FILE *         fp,
                                       const PSIMsa * msa);
#endif /* DEBUG_PSSM_ENGINE */
     ...
     */
    NCBI_XBLAST_EXPORT PSIMatrix * PSIMatrixNew(Uint4 query_length,
            Uint4                                     alphabet_size);
     ...
     * @return NULL
     */
    NCBI_XBLAST_EXPORT PSIMatrix * PSIMatrixFree(PSIMatrix * matrix);
    ...
    typedef struct PSIDiagnosticsRequest
    {
        ...
        Boolean residue_frequencies;             /**<
                                                  *  request observed residue
                                                  * frequencies
                                                  */
        Boolean weighted_residue_frequencies;    /**<
                                                  *  request observed weighted
                                                  * residue frequencies
                                                  */
        ...
        Boolean num_matching_seqs;               /**<
                                                  *  request number of matching
                                                  * sequences
                                                  */
        Boolean independent_observations;        /**<
                                                  *  request number of independent
                                                  *    observations
                                                  */
     ...
     * failure
     */
    NCBI_XBLAST_EXPORT PSIDiagnosticsRequest * PSIDiagnosticsRequestNew(void);
     ...
     * failure
     */
    NCBI_XBLAST_EXPORT PSIDiagnosticsRequest * PSIDiagnosticsRequestNewEx(Boolean save_ascii_pssm);
     ...
     * @return NULL
     */
    NCBI_XBLAST_EXPORT PSIDiagnosticsRequest * PSIDiagnosticsRequestFree(PSIDiagnosticsRequest * diags_request);
     ...
     * request are NULL
     */
    NCBI_XBLAST_EXPORT PSIDiagnosticsResponse * PSIDiagnosticsResponseNew(Uint4 query_length,
            Uint4                                                               alphabet_size,
     ...
     * @return NULL
     */
    NCBI_XBLAST_EXPORT PSIDiagnosticsResponse * PSIDiagnosticsResponseFree(PSIDiagnosticsResponse * diags);
     ...
     */
    NCBI_XBLAST_EXPORT int PSICreatePssm(const PSIMsa * msap,
     ...
     * @return PSI_SUCCESS on success, otherwise one of the PSIERR_* constants
     */
    NCBI_XBLAST_EXPORT int PSICreatePssmWithDiagnostics(const PSIMsa * msap,
            const PSIBlastOptions *                                    options,
            BlastScoreBlk *                                            sbp,
            const PSIDiagnosticsRequest *                              request,
            PSIMatrix **                                               pssm,
     ...
     */
    NCBI_XBLAST_EXPORT int PSICreatePssmFromFrequencyRatios(const Uint1 * query,
            Uint4                                                         query_length,
            BlastScoreBlk *                                               sbp,
            double **                                                     freq_ratios,
