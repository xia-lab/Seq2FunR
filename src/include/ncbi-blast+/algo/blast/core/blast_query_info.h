...
extern "C"
{
    ...
    {
        Int4    query_offset;         /**<
                                       *  Offset of this query, strand or frame in the
    ...
    typedef struct BlastQueryInfo
    {
        ...
        Uint4              max_length;         /**<
                                                *  Length of the longest among the concatenated
                                                *  queries
                                                */

        struct SPHIQueryInfo *pattern_info;    /**<
                                                *  Counts of PHI BLAST pattern
    ...
    NCBI_XBLAST_EXPORT BlastQueryInfo * BlastQueryInfoNew(EBlastProgramType program,
            int                                                             num_queries);

    /** Deallocate memory for query information structure */
    NCBI_XBLAST_EXPORT BlastQueryInfo * BlastQueryInfoFree(BlastQueryInfo * query_info);

    /** Duplicates the query information structure */
    NCBI_XBLAST_EXPORT BlastQueryInfo * BlastQueryInfoDup(const BlastQueryInfo * query_info);
     ...
     */
    NCBI_XBLAST_EXPORT Int4 Blast_GetQueryIndexFromContext(Int4 context,
     ...
     */
    NCBI_XBLAST_EXPORT Int4 Blast_GetQueryIndexFromQueryOffset(Int4 query_offset,
            EBlastProgramType                                       program,
     ...
     * set
     */
    NCBI_XBLAST_EXPORT Int8 BlastQueryInfoGetEffSearchSpace(const BlastQueryInfo * qinfo,
            EBlastProgramType                                                      program,
            Int4                                                                   query_index);
     ...
     */
    NCBI_XBLAST_EXPORT void BlastQueryInfoSetEffSearchSpace(BlastQueryInfo * qinfo,
            EBlastProgramType                                                program,
            Int4                                                             query_index,
            Int8                                                             eff_searchsp);
     ...
     */
    NCBI_XBLAST_EXPORT Int4 BlastQueryInfoGetQueryLength(const BlastQueryInfo * qinfo,
            EBlastProgramType                                                   program,
            Int4                                                                query_index);
     ...
     */
    NCBI_XBLAST_EXPORT Int2 Blast_GetOneQueryStructs(BlastQueryInfo ** one_query_info_ptr,
    ...
    NCBI_XBLAST_EXPORT Int4 BSearchContextInfo(Int4 n,
     ...
     */
    NCBI_XBLAST_EXPORT Uint4 QueryInfo_GetSeqBufLen(const BlastQueryInfo * qinfo);
     ...
     */
    NCBI_XBLAST_EXPORT Int4 * ContextOffsetsToOffsetArray(const BlastQueryInfo * info);
     ...
     */
    NCBI_XBLAST_EXPORT void OffsetArrayToContextOffsets(BlastQueryInfo * info,
            Int4 *                                                       new_offsets,
