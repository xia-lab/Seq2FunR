...
extern "C"
{
     ...
     *  @return log(x+1)
     */
    NCBI_XBLAST_EXPORT double BLAST_Log1p(double x);
     ...
     *  @return exp(x) - 1
     */
    NCBI_XBLAST_EXPORT double BLAST_Expm1(double x);
     ...
     */
    NCBI_XBLAST_EXPORT double BLAST_Factorial(Int4 n);
     ...
     *  @return log(1 * 2 * 3 * ... * x)
     */
    NCBI_XBLAST_EXPORT double BLAST_LnFactorial(double x);
     ...
     */
    NCBI_XBLAST_EXPORT double BLAST_LnGammaInt(Int4 n);
     ...
     */
    NCBI_XBLAST_EXPORT double BLAST_RombergIntegrate(double (*f)(double, void *),
            void * fargs,
            double p,
            double q,
            double eps,
     ...
     */
    NCBI_XBLAST_EXPORT Int4 BLAST_Gcd(Int4 a,
                                      Int4 b);
     ...
     */
    NCBI_XBLAST_EXPORT Int4 BLAST_Gdb3(Int4 * a,
                                       Int4 * b,
                                       Int4 * c);
     ...
     *  @return floor(x + 0.5);
     */
    NCBI_XBLAST_EXPORT long BLAST_Nint(double x);
     ...
     */
    NCBI_XBLAST_EXPORT double BLAST_Powi(double x,
            Int4                                n);
