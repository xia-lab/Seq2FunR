...
static char const rcsid[] = "$Id: blast_dynarray.c 113776 2007-11-08 22:38:18Z camacho $";
...
{
    SDynamicUint4Array * retval = (SDynamicUint4Array *) calloc(1, sizeof(SDynamicUint4Array));
...
static Int2 s_DynamicUint4Array_ReallocIfNecessary(SDynamicUint4Array * arr)
{
    ...
    if (arr -> num_used + 1 > arr -> num_allocated)
    {
        ...
        Uint4 * reallocation = (Uint4 *) realloc(arr -> data,
...
SDynamicUint4Array * DynamicUint4Array_Dup(const SDynamicUint4Array * src)
{
    ...
    memcpy((void *) retval -> data, (void *) src -> data, sizeof(*src -> data) * src -> num_used);
                            ...
                            const SDynamicUint4Array * src)
{
    ...
    {
        /* we need more room for elements */
        Uint4 * reallocation = (Uint4 *) realloc(dest -> data, src -> num_allocated * sizeof(*dest -> data));
...
{
    SDynamicInt4Array * retval = (SDynamicInt4Array *) calloc(1, sizeof(SDynamicInt4Array));
...
{
    SDynamicSGenCodeNodeArray * retval = (SDynamicSGenCodeNodeArray *) calloc(1, sizeof(SDynamicSGenCodeNodeArray));
    ...
    retval -> data = (SGenCodeNode *) calloc(INIT_NUM_GEN_CODES, sizeof(SGenCodeNode));
...
static Int2 s_DynamicSGenCodeNodeArray_ReallocIfNecessary(SDynamicSGenCodeNodeArray * arr)
{
    ...
    if (arr -> num_used + 1 > arr -> num_allocated)
    {
        ...
        SGenCodeNode * reallocation = (SGenCodeNode *) realloc(arr -> data,
                                                               kResizeFactor * arr -> num_allocated
                                                               * sizeof(*arr -> data));
...
static void s_DynamicSGenCodeNodeArray_Sort(SDynamicSGenCodeNodeArray * arr)
{
    ...
    {
        qsort(arr -> data, arr -> num_used, sizeof(SGenCodeNode), s_SGenCodeNodeCompare);
    }
}
        ...
        SGenCodeNode                                             element)
{
    ...
    arr -> data[arr -> num_used].gc_str = (Uint1 *) BlastMemDup(element.gc_str, GENCODE_STRLEN);
