...
#define kScoreMatrixScoreRange 10000
     ...
     * @return NULL
     */
    Kappa_posSearchItems * Kappa_posSearchItemsFree(Kappa_posSearchItems * posSearchItems);
     ...
     * @return NULL
     */
    Kappa_compactSearchItems * Kappa_compactSearchItemsFree(Kappa_compactSearchItems * compactSearchItems);
