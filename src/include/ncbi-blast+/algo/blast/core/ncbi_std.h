...
#  endif
     ...
     *   or allocation fails.
     */
    NCBI_XBLAST_EXPORT void * BlastMemDup(const void * orig,
            size_t                                     size);
     ...
     */
    NCBI_XBLAST_EXPORT ListNode * ListNodeNew(ListNode * vnp);
     ...
     * @return New node
     */
    NCBI_XBLAST_EXPORT ListNode * ListNodeAdd(ListNode ** head);
     ...
     * @return New node
     */
    NCBI_XBLAST_EXPORT ListNode * ListNodeAddPointer(ListNode ** head,
            Uint1                                                choice,
            void *                                               value);
     ...
     * @return NULL
     */
    NCBI_XBLAST_EXPORT ListNode * ListNodeFree(ListNode * vnp);
     ...
     * @return NULL
     */
    NCBI_XBLAST_EXPORT ListNode * ListNodeFreeData(ListNode * vnp);
     ...
     * @return newly allocated node
     */
    NCBI_XBLAST_EXPORT ListNode * ListNodeCopyStr(ListNode ** head,
            Uint1                                             choice,
            const char *                                      str);
