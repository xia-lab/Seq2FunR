...
extern "C"
{
     ...
     */
    NCBI_XBLAST_EXPORT Int2 LookupTableWrapInit(BLAST_SequenceBlk * query,
    ...
    NCBI_XBLAST_EXPORT LookupTableWrap * LookupTableWrapFree(LookupTableWrap * lookup);
...
#define OFFSET_ARRAY_SIZE 4096
     ...
     */
    NCBI_XBLAST_EXPORT Int4 GetOffsetArraySize(LookupTableWrap * lookup);
