...
extern "C"
{
     ...
     */
    NCBI_XBLAST_EXPORT SFreqRatios * _PSIMatrixFrequencyRatiosNew(const char * matrix_name);

    /** Deallocate the frequency ratios structure */
    NCBI_XBLAST_EXPORT SFreqRatios * _PSIMatrixFrequencyRatiosFree(SFreqRatios * freq_ratios);
