...
extern "C"
{
     ...
     */
    NCBI_XBLAST_EXPORT BlastHSPCollectorParams * BlastHSPCollectorParamsNew(const BlastHitSavingOptions * hit_options,
     ...
     * @return NULL
     */
    NCBI_XBLAST_EXPORT BlastHSPCollectorParams * BlastHSPCollectorParamsFree(BlastHSPCollectorParams * opts);
     ...
     */
    NCBI_XBLAST_EXPORT BlastHSPWriterInfo * BlastHSPCollectorInfoNew(BlastHSPCollectorParams * params);
