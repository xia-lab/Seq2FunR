...
extern "C"
{
     ...
     */
    NCBI_XBLAST_EXPORT BlastHSPWriter * BlastHSPWriterNew(BlastHSPWriterInfo ** writer_info,
     ...
     */
    NCBI_XBLAST_EXPORT BlastHSPPipeInfo * BlastHSPPipeInfo_Add(BlastHSPPipeInfo ** head,
     ...
     * [in]
     */
    NCBI_XBLAST_EXPORT BlastHSPPipe * BlastHSPPipeNew(BlastHSPPipeInfo ** pipe_info,
            BlastQueryInfo *                                              query_info);
