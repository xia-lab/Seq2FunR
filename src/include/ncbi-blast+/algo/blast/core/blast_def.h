...
#define sfree(x) __sfree((void**)(void*)&(x))
    ...
    NCBI_XBLAST_EXPORT void __sfree(void ** x);
...
#define KAPPA_PRINT_DIAGNOSTICS 1
     ...
     */
    NCBI_XBLAST_EXPORT SSeqRange SSeqRangeNew(Int4 start,
            Int4                                   stop);
     ...
     */
    NCBI_XBLAST_EXPORT Int4 SSeqRangeArrayLessThanOrEqual(const SSeqRange * ranges,
            Int4                                                            num_ranges,
            Int4                                                            target);
    ...
    typedef enum ESubjectMaskingType { eNoSubjMasking, eSoftSubjMasking, eHardSubjMasking } ESubjectMaskingType;
    ...
    typedef struct BLAST_SequenceBlk
    {
        ...
        Uint1 *        sequence_start;              /**<
                                                     *  Start of sequence, usually one byte before
        ...
        Boolean        sequence_allocated;          /**<
                                                     *  TRUE if memory has been allocated for
                                                     *  sequence
                                                     */
        ...
        Boolean        nomask_allocated;            /**<
                                                     *  If false the two above are just pointers to
                                                     *     sequence and sequence_start.
                                                     */
        Uint1 *        oof_sequence;                /**<
                                                     *  Mixed-frame protein representation of a
        ...
        BlastMaskLoc * lcase_mask;                  /**<
                                                     *  Locations to be masked from operations on
        ...
        Boolean        lcase_mask_allocated;        /**<
                                                     ...
                                                     */
        Int4           chunk;                       /**<
                                                     *  Used for indexing only: the chunk number within the
                                                     *    subject sequence.
                                                     */
        Uint1 *        gen_code_string;             /**<
                                                     *  for nucleotide subject sequences (tblast[nx]),
    ...
    typedef struct SPHIQueryInfo
    {
        ...
        SPHIPatternInfo * occurrences;       /**<
                                              *  Array of pattern occurrence information
                                              *     structures.
                                              */
    ...
    {
        EBlastStage stage;        /**<
                                   *  Stage of the BLAST search currently in
                                   * progress
                                   */
     ...
     */
    NCBI_XBLAST_EXPORT SBlastProgress * SBlastProgressNew(void * user_data);

    /**
     *  Deallocates a SBlastProgress structure.
     * Implemented in blast_util.c
     */
    NCBI_XBLAST_EXPORT SBlastProgress * SBlastProgressFree(SBlastProgress * progress_info);
     ...
     */
    NCBI_XBLAST_EXPORT void SBlastProgressReset(SBlastProgress * progress_info);
