...
extern "C"
{
    ...
    NCBI_XBLAST_EXPORT extern const Uint1 kNuclMask;

    /** NCBISTDAA element used to mask residues in BLAST */
    NCBI_XBLAST_EXPORT extern const Uint1 kProtMask;
...
#define REPEAT_MASK_LINK_VALUE 5
     ...
     * list).
     */
    NCBI_XBLAST_EXPORT BlastSeqLoc * BlastSeqLocNew(BlastSeqLoc ** head,
            Int4                                                   from,
            Int4                                                   to);
     ...
     * list)
     */
    NCBI_XBLAST_EXPORT BlastSeqLoc * BlastSeqLocAppend(BlastSeqLoc ** head,
            BlastSeqLoc *                                             node);
     ...
     * @return NULL
     */
    NCBI_XBLAST_EXPORT BlastSeqLoc * BlastSeqLocNodeFree(BlastSeqLoc * node);
     ...
     */
    NCBI_XBLAST_EXPORT BlastSeqLoc * BlastSeqLocFree(BlastSeqLoc * loc);
     ...
     */
    NCBI_XBLAST_EXPORT BlastSeqLoc * BlastSeqLocListDup(BlastSeqLoc * head);
     ...
     */
    NCBI_XBLAST_EXPORT void BlastSeqLocReverse(BlastSeqLoc * masks,
            Int4                                             query_length);
     ...
     */
    NCBI_XBLAST_EXPORT void BlastSeqLocCombine(BlastSeqLoc ** mask_loc,
            Int4                                              link_value);
     ...
     */
    NCBI_XBLAST_EXPORT BlastMaskLoc * BlastMaskLocNew(Int4 total);
     ...
     */
    NCBI_XBLAST_EXPORT BlastMaskLoc * BlastMaskLocDup(const BlastMaskLoc * mask_loc);
     ...
     * @return NULL pointer
     */
    NCBI_XBLAST_EXPORT BlastMaskLoc * BlastMaskLocFree(BlastMaskLoc * mask_loc);
     ...
     */
    NCBI_XBLAST_EXPORT Int2 BlastMaskLocDNAToProtein(BlastMaskLoc * mask_loc,
     ...
     * @param query_info Query information structure, containing contexts data [in]
     */
    NCBI_XBLAST_EXPORT Int2 BlastMaskLocProteinToDNA(BlastMaskLoc * mask_loc,
            const BlastQueryInfo *                                  query_info);
     ...
     */
    NCBI_XBLAST_EXPORT Int2 BLAST_ComplementMaskLocations(EBlastProgramType program_number,
            const BlastQueryInfo *                                          query_info,
     ...
     */
    NCBI_XBLAST_EXPORT Int2 BlastSetUp_Filter(EBlastProgramType program_number,
            Uint1 *                                             sequence,
            Int4                                                length,
            Int4                                                offset,
     ...
     */
    NCBI_XBLAST_EXPORT Int2 BlastSetUp_GetFilteringLocations(BLAST_SequenceBlk * query_blk,
            const BlastQueryInfo *                                               query_info,
     ...
     */
    NCBI_XBLAST_EXPORT void Blast_MaskTheResidues(Uint1 * buffer,
            Int4                                          length,
            Boolean                                       is_na,
     ...
     *            are masked [in]
     */
    NCBI_XBLAST_EXPORT void Blast_MaskUnsupportedAA(BLAST_SequenceBlk * seq,
            Uint1                                                       min_invalid);
     ...
     * @param program_number one of blastn,blastp,blastx,etc. [in]
     */
    NCBI_XBLAST_EXPORT void BlastSetUp_MaskQuery(BLAST_SequenceBlk * query_blk,
            const BlastQueryInfo *                                   query_info,
     ...
     * @return zero on success
     */
    NCBI_XBLAST_EXPORT Int2 BlastFilteringOptionsFromString(EBlastProgramType program_number,
    ...
    NCBI_XBLAST_EXPORT char * BlastFilteringOptionsToString(const SBlastFilterOptions * filtering_options);
