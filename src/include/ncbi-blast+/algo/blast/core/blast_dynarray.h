...
#define INIT_NUM_ELEMENTS 8
     ...
     */
    NCBI_XBLAST_EXPORT SDynamicUint4Array * DynamicUint4ArrayNew();
     ...
     * @return NULL if out of memory otherwise, newly allocated structure
     */
    NCBI_XBLAST_EXPORT SDynamicUint4Array * DynamicUint4ArrayNewEx(Uint4 init_num_elements);
     ...
     * @return NULL
     */
    NCBI_XBLAST_EXPORT SDynamicUint4Array * DynamicUint4ArrayFree(SDynamicUint4Array * arr);
     ...
     * and this failed
     */
    NCBI_XBLAST_EXPORT Int2 DynamicUint4Array_Append(SDynamicUint4Array * arr,
            Uint4                                                         element);
     ...
     */
    NCBI_XBLAST_EXPORT SDynamicUint4Array * DynamicUint4Array_Dup(const SDynamicUint4Array * src);
     ...
     * @return newly allocated data structure or NULL if out of memory
     */
    NCBI_XBLAST_EXPORT Int4 DynamicUint4Array_Copy(SDynamicUint4Array * dest,
     ...
     */
    NCBI_XBLAST_EXPORT Boolean DynamicUint4Array_AreEqual(const SDynamicUint4Array * a,
     ...
     * @return NULL if out of memory otherwise, newly allocated structure
     */
    NCBI_XBLAST_EXPORT SDynamicInt4Array * DynamicInt4ArrayNew();
     ...
     * @return NULL
     */
    NCBI_XBLAST_EXPORT SDynamicInt4Array * DynamicInt4ArrayFree(SDynamicInt4Array * arr);
     ...
     * and this failed
     */
    NCBI_XBLAST_EXPORT Int2 DynamicInt4Array_Append(SDynamicInt4Array * arr,
            Int4                                                        element);
...
#define INIT_NUM_GEN_CODES 30
     ...
     * @return NULL if out of memory otherwise, newly allocated structure
     */
    NCBI_XBLAST_EXPORT SDynamicSGenCodeNodeArray * DynamicSGenCodeNodeArrayNew();
     ...
     * @return NULL
     */
    NCBI_XBLAST_EXPORT SDynamicSGenCodeNodeArray * DynamicSGenCodeNodeArrayFree(SDynamicSGenCodeNodeArray * arr);
     ...
     * element is NULL.
     */
    NCBI_XBLAST_EXPORT Int2 DynamicSGenCodeNodeArray_Append(SDynamicSGenCodeNodeArray * arr,
