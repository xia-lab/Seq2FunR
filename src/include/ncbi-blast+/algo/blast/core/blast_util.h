...
#define NCBI2NA_UNPACK_BASE(x, N) (((x)>>(2*(N))) & NCBI2NA_MASK)
    ...
    NCBI_XBLAST_EXPORT void BlastSequenceBlkClean(BLAST_SequenceBlk * seq_blk);

    /** Deallocate memory for a sequence block */
    NCBI_XBLAST_EXPORT BLAST_SequenceBlk * BlastSequenceBlkFree(BLAST_SequenceBlk * seq_blk);
     ...
     */
    NCBI_XBLAST_EXPORT void BlastSequenceBlkCopy(BLAST_SequenceBlk ** copy,
     ...
     */
    NCBI_XBLAST_EXPORT Int2 BlastProgram2Number(const char * program,
     ...
     */
    NCBI_XBLAST_EXPORT Int2 BlastNumber2Program(EBlastProgramType number,
            char **                                               program);
     ...
     */
    NCBI_XBLAST_EXPORT Int2 BlastSetUp_SeqBlkNew(const Uint1 * buffer,
            Int4                                               length,
     ...
     * allocated [out]
     */
    NCBI_XBLAST_EXPORT Int2 BlastSeqBlkNew(BLAST_SequenceBlk ** retval);
     ...
     */
    NCBI_XBLAST_EXPORT Int2 BlastSeqBlkSetSequence(BLAST_SequenceBlk * seq_blk,
     ...
     */
    NCBI_XBLAST_EXPORT Int2 BlastSeqBlkSetCompressedSequence(BLAST_SequenceBlk * seq_blk,
            const Uint1 *                                                        sequence);
     ...
     */
    NCBI_XBLAST_EXPORT Int2 BlastSeqBlkSetSeqRanges(BLAST_SequenceBlk * seq_blk,
     ...
     */
    NCBI_XBLAST_EXPORT Int2 BlastCompressBlastnaSequence(BLAST_SequenceBlk * seq_blk);
     ...
     */
    NCBI_XBLAST_EXPORT Int4 BLAST_GetTranslation(const Uint1 * query_seq,
     ...
     */
    NCBI_XBLAST_EXPORT Int4 BLAST_TranslateCompressedSequence(Uint1 * translation,
            Int4                                                      length,
            const Uint1 *                                             nt_seq,
            Int2                                                      frame,
            Uint1 *                                                   prot_seq);
     ...
     */
    NCBI_XBLAST_EXPORT Int2 GetReverseNuclSequence(const Uint1 * sequence,
            Int4                                                 length,
     ...
     */
    NCBI_XBLAST_EXPORT Int1 BLAST_ContextToFrame(EBlastProgramType prog_number,
     ...
     */
    NCBI_XBLAST_EXPORT Int2 BLAST_PackDNA(const Uint1 * buffer,
            Int4                                        length,
     ...
     */
    NCBI_XBLAST_EXPORT size_t BLAST_GetTranslatedProteinLength(size_t nucleotide_length,
     ...
     */
    NCBI_XBLAST_EXPORT Int2 BLAST_CreateMixedFrameDNATranslation(BLAST_SequenceBlk * query_blk,
     ...
     */
    NCBI_XBLAST_EXPORT Int2 BLAST_GetAllTranslations(const Uint1 * nucl_seq,
            EBlastEncoding                                         encoding,
            Int4                                                   nucl_length,
            const Uint1 *                                          genetic_code,
     ...
     *                      not NULL. [out]
     */
    NCBI_XBLAST_EXPORT int Blast_GetPartialTranslation(const Uint1 * nucl_seq,
            Int4                                                     nucl_length,
            Int2                                                     frame,
            const Uint1 *                                            genetic_code,
            Uint1 **                                                 translation_buffer_ptr,
     ...
     */
    NCBI_XBLAST_EXPORT Int4 BLAST_FrameToContext(Int2 frame,
            EBlastProgramType                         program);

    /** The following binary search routine assumes that array A is filled. */
    NCBI_XBLAST_EXPORT Int4 BSearchInt4(Int4 n,
            Int4 *                           A,
            Int4                             size);
     ...
     */
    NCBI_XBLAST_EXPORT double * BLAST_GetStandardAaProbabilities(void);
     ...
     * out of memory
     */
    NCBI_XBLAST_EXPORT char * BLAST_StrToUpper(const char * string);
...
#define FENCE_SENTRY 201
     ...
     */
    NCBI_XBLAST_EXPORT unsigned int BLAST_GetNumberOfContexts(EBlastProgramType program);

    /**
     *  Free SBlastTargetTranslation
     * @param target_t object to be freed [in]
     */
    NCBI_XBLAST_EXPORT SBlastTargetTranslation * BlastTargetTranslationFree(SBlastTargetTranslation * target_t);
     ...
     */
    NCBI_XBLAST_EXPORT Int2 BlastTargetTranslationNew(BLAST_SequenceBlk * subject_blk,
