...
#define kBestHit_ScoreEdgeMax  0.5
    ...
    typedef struct BlastHSPBestHitParams
    {
        ...
        Int4              prelim_hitlist_size;    /**<
                                                   *  number of hits saved during preliminary
                                                   *    part of search.
                                                   */
     ...
     */
    NCBI_XBLAST_EXPORT BlastHSPBestHitParams * BlastHSPBestHitParamsNew(const BlastHitSavingOptions * hit_options,
     ...
     * @return NULL
     */
    NCBI_XBLAST_EXPORT BlastHSPBestHitParams * BlastHSPBestHitParamsFree(BlastHSPBestHitParams * opts);
     ...
     */
    NCBI_XBLAST_EXPORT BlastHSPWriterInfo * BlastHSPBestHitInfoNew(BlastHSPBestHitParams * params);

    NCBI_XBLAST_EXPORT BlastHSPPipeInfo * BlastHSPBestHitPipeInfoNew(BlastHSPBestHitParams * params);
