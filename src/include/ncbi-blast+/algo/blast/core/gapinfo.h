...
extern "C"
{
     ...
     */
    NCBI_XBLAST_EXPORT GapEditScript * GapEditScriptNew(Int4 size);
     ...
     *  @return NULL
     */
    NCBI_XBLAST_EXPORT GapEditScript * GapEditScriptDelete(GapEditScript * esp);
     ...
     *  @return Pointer to the new edit script
     */
    NCBI_XBLAST_EXPORT GapEditScript * GapEditScriptDup(const GapEditScript * old);
     ...
     *  @return 0 on success
     */
    NCBI_XBLAST_EXPORT Int2 GapEditScriptPartialCopy(GapEditScript * new_esp,
            int                                                      offset,
     ...
     *  @return Always NULL
     */
    NCBI_XBLAST_EXPORT GapPrelimEditBlock * GapPrelimEditBlockFree(GapPrelimEditBlock * edit_block);

    /**
     *  Allocates a preliminary edit block structure
     *  @return Pointer to the allocated preliminary edit block
     */
    NCBI_XBLAST_EXPORT GapPrelimEditBlock * GapPrelimEditBlockNew(void);
     ...
     */
    NCBI_XBLAST_EXPORT void GapPrelimEditBlockAdd(GapPrelimEditBlock * edit_block,
     ...
     *                    the first.
     */
    NCBI_XBLAST_EXPORT void GapPrelimEditBlockAppend(GapPrelimEditBlock * edit_block1,
     ...
     */
    NCBI_XBLAST_EXPORT void GapPrelimEditBlockReset(GapPrelimEditBlock * edit_block);
     ...
     * @return Always NULL
     */
    NCBI_XBLAST_EXPORT GapStateArrayStruct * GapStateFree(GapStateArrayStruct * state_struct);
