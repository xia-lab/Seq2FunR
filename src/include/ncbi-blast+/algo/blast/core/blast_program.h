...
#define PATTERN_QUERY_MASK      (0x1<<8)
    ...
    typedef enum
    {
        ...
        eBlastTypeBlastx  = (NUCLEOTIDE_QUERY_MASK | PROTEIN_SUBJECT_MASK | TRANSLATED_QUERY_MASK),
        eBlastTypeTblastn = (PROTEIN_QUERY_MASK | NUCLEOTIDE_SUBJECT_MASK | TRANSLATED_SUBJECT_MASK),
        eBlastTypeTblastx = (NUCLEOTIDE_QUERY_MASK | NUCLEOTIDE_SUBJECT_MASK | TRANSLATED_QUERY_MASK
     ...
     */
    NCBI_XBLAST_EXPORT Boolean Blast_QueryIsProtein(EBlastProgramType p);

    /**
     *  Returns true if the query is nucleotide
     * @param p program type [in]
     */
    NCBI_XBLAST_EXPORT Boolean Blast_QueryIsNucleotide(EBlastProgramType p);

    /**
     *  Returns true if the query is PSSM
     * @param p program type [in]
     */
    NCBI_XBLAST_EXPORT Boolean Blast_QueryIsPssm(EBlastProgramType p);
     ...
     * @param p program type [in]
     */
    NCBI_XBLAST_EXPORT Boolean Blast_SubjectIsProtein(EBlastProgramType p);

    /**
     *  Returns true if the subject is nucleotide
     * @param p program type [in]
     */
    NCBI_XBLAST_EXPORT Boolean Blast_SubjectIsNucleotide(EBlastProgramType p);

    /**
     *  Returns true if the subject is PSSM
     * @param p program type [in]
     */
    NCBI_XBLAST_EXPORT Boolean Blast_SubjectIsPssm(EBlastProgramType p);
     ...
     * @param p program type [in]
     */
    NCBI_XBLAST_EXPORT Boolean Blast_QueryIsTranslated(EBlastProgramType p);

    /**
     *  Returns true if the subject is translated
     * @param p program type [in]
     */
    NCBI_XBLAST_EXPORT Boolean Blast_SubjectIsTranslated(EBlastProgramType p);
     ...
     * @param p program type [in]
     */
    NCBI_XBLAST_EXPORT Boolean Blast_ProgramIsPsiBlast(EBlastProgramType p);

    /**
     *  Returns true if program is PHI-BLAST (i.e.: involves a pattern)
     * @param p program type [in]
     */
    NCBI_XBLAST_EXPORT Boolean Blast_ProgramIsPhiBlast(EBlastProgramType p);

    /**
     *  Returns true if program is RPS-BLAST (i.e.: involves a PSSM as subject)
     * @param p program type [in]
     */
    NCBI_XBLAST_EXPORT Boolean Blast_ProgramIsRpsBlast(EBlastProgramType p);

    /**
     *  Returns true if program is not undefined
     * @param p program type [in]
     */
    NCBI_XBLAST_EXPORT Boolean Blast_ProgramIsValid(EBlastProgramType p);
